...
def nbo(path,text_log):
    ...
    def file_search(fname):
        ...
        types=(core,sigma,total,pi)#,lp1,lp2,lp3,cc,ci,ii)#,type_1,type_2)#,ry_p1,ry_p2,ry_d1,ry_d2)
        ...
        adf.Create_Files_Adf(path,z,types,"nbo_run")


    ###Execute
    adf.Get_Adf_Geom(path,dirs,"nbo_run")
