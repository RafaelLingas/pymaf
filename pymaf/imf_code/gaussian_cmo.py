            ...
            for line in input_data:
                ...
                if check_orbs_flag==True:
                    if finding_orbs_flag==True and 'vir' in line:
                        ...
                        core_num=int(core.orbs[len(core.orbs)-1])
                ...
                if cmo_matrix_flag==True and 'Total' in line:
                    ...
                    ### try to give a value to core from the beginning
                    for k in range(0,9):
                            core.values[k,ghost_num]=0.0
                    core.values[9,ghost_num]=0.0
            ...
            for item in types:
                ...
                for k in range(0,ghost_num):
                    try:
                        ...
                        ##print(item.values(m,k)) i dont know why tihs was here
