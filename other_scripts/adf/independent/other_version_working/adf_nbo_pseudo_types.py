...
def file_search(fname):
    ...
    pi = adf.Orbital("pi")
    type_1 = adf.Orbital("guest")
    type_2 = adf.Orbital("host")
    #mg=adf.Orbital("Mg")
    ...
    types=(total,pi,type_1,type_2)#mg)#,ry_p1,ry_p2,ry_d1,ry_d2)
                    ...
                    if check_if_pi==True:
                        if '%' in line:
                            ...
                            if p_perc>90.0:
                                ...
                                ####pi type
                                # print(uncut_BD)
                                which_type=uncut_BD[len(uncut_BD)-1]
                                if 'C' in which_type:
                                    which_type=which_type.replace('C','')
                                if int(which_type)>60:
                                    type_1.orbs.append(n_bd)
                                else:
                                    type_2.orbs.append(n_bd)
